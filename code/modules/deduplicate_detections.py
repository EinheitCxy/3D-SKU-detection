...
def main():
    ...
    parser.add_argument('--algorithm', type=str, choices=['point_tracking', '3d_mapping'], default='point_tracking',
                        help='算法类型：point_tracking=点追踪；3d_mapping=3D映射（默认 point_tracking）')
    parser.add_argument('--backend', type=str, choices=['vggt', 'pi3'], default=None,
                        help='3D算法后端：vggt或pi3（仅在algorithm=3d_mapping时生效）')
